...
#ifndef CP5_EX15_21_GEOMTRIC_H_
#define CP5_EX15_21_GEOMTRIC_H_
...
namespace EX21{
    ...
    public:
        ...
        Cone(float center_x, float center_y, float center_z, float radius, float height) : Shape_3D (center_x, center_y, center_z),
